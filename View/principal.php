...
<!-- Navbar -->
<nav class="w3-sidebar w3-bar w3-block w3-center w3-cyan shadow-lg">
    <a href="#home"
       class="w3-bar-item w3-button w3-block w3-cell w3-hover-sand w3-hover-text-aqua w3-text-sand w3-text-dark-grey">
...
<div class="w3-padding-large exibicao" id="main">
    ...
    <header class="w3-container w3-padding-32 w3-center title-section" id="home">
        <img src="../Resources/Img/enlatado.png" alt="Logo" class="w3-image logo" style="max-height: 150px;">
            ...
            <div class="w3-row w3-section">
                <div class="w3-center">
                    <button name="btnAtualizar"
                            class="btn w3-block w3-margin w3-cyan w3-cell w3-round-large w3-hover-aqua"
                    ...
                    <div class="w3-row w3-section">
                        <div class="w3-center" style="">
                            <button name="btnAddFormacao"
                                    class="btn w3-button w3-block w3-cyan w3-cell w3-round-large w3-hover-aqua"
                                    style="width: 20%;">
                    ...
                    <div class="w3-row w3-section">
                        <div class="w3-center" style="">
                            <button name="btnAddEP"
                                    class="btn w3-button w3-block w3-cyan w3-cell w3-round-large w3-hover-sand w3-hover-aqua"
                                    style="width: 20%;">
                                <i class="w3-xxlarge fa fa-user-plus"></i>

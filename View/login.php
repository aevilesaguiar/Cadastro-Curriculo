...
<form action="Controller/Navegacao.php" method="post"
    ...
    <div class="w3-row w3-section">
        <div class="w3-half" style="">
            <button name="btnLogin" class="w3-button w3-block w3-margin w3-cyan w3-hover-aqua w3-cell w3-round-large"
                    style="width: 90%;">ENTRAR
            </button>
        </div>
        <div class="w3-half">
            <button name="btnPrimeiroAcesso" class="w3-button w3-block w3-margin w3-cyan w3-hover-aqua w3-cell w3-round-large"
                    style="width: 90%;">PRIMEIRO ACESSO?
            </button>
        </div>
    </div>
    <div class="w3-center" style="">
        <button name="btnADM" class="w3-button w3-light-gray w3-border w3-border-cyan w3-hover-aqua w3-round-large mb-3 w3-text-dark-gray"

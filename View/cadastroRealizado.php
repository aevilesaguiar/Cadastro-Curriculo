...
<form action="Navegacao.php" method="post"
    ...
    <div class="w3-row w3-section">
        <div>
            <button name="btnCadRealizado" class="w3-button w3-block w3-margin w3-text-dark-grey w3-aqua w3-hover-cyan w3-cell w3-round-large"
                    style="width: 90%;">Cadastro Realizado Com Sucesso!
            </button>
        </div>
    </div>
</form>
